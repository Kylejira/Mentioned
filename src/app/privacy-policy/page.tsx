...
export const metadata: Metadata = {
  title: "Privacy Policy | Mentioned.pro",
  description:
    "Privacy Policy for Mentioned.pro - Learn how we collect, use, and protect your personal information.",
  robots: { index: true, follow: true },
  alternates: {
    canonical: "https://mentioned.pro/privacy-policy",
  },
}

function getPrivacyPolicyContent(): string {
  try {
    const path = join(process.cwd(), "privacy-policy.md")
    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-white to-slate-50">
      ...
      <main className="pt-20 sm:pt-24 pb-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
          <article
            className="privacy-policy-content max-w-none"
