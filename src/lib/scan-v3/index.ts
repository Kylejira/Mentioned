...
export type { ScanResult } from "./orchestrator"
...
export type { DetectionResult, ResponseAnalysis, AliasRegistry } from "./detection/types"

export { ScoringEngine } from "./scoring/scoring-engine"
export { SCORING_WEIGHTS } from "./scoring/weights"
export type { ScoringInput, ScoringBreakdown } from "./scoring/types"
